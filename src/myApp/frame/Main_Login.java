...
import myApp.client.cst.Lookup_JoinUser;
...
public class Main_Login implements InterfaceServiceCall, InterfaceLookupResult {
...
//	private final Dialog loginDialog = new Dialog();
	...
	public void open() {
		...
		//	이미지 ADD
		//----------------------------------------
		HTML image = new HTML("<center><div><img src='img/Login.jpg' width='333' height='101'></center></div>"); 
...
//	    formPanel.setBorders(true);
	...
	public void setLookupResult(Object result) {
		...
		this.firstName.setValue(userModel.getEmail());
	}
